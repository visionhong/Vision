...
if __name__ == "__main__":
    ...
    for epoch in range(opt.epochs):
        ...
        for batch_i, (_, imgs, targets) in enumerate(tqdm.tqdm(dataloader, desc=f"Training Epoch {epoch}")):
            ...
            loss, outputs = model(imgs, targets)  # loss,  (2, 10647, 85)
            # pdb.set_trace()
            loss.backward()
            ...
            metric_table = [['Metrics', *[f'YOLO Layer {i}' for i in range(len(model.yolo_layers))]]]  # [['Metrics', 'YOLO Layer 0', 'YOLO Layer 1', 'YOLO Layer 2']]
            ...
            log_str += AsciiTable(metric_table).table  # 각 loss에 대한 정보를 예쁘게 표현
