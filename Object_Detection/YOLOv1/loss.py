...
class Loss(nn.Module):
    ...
    def __init__(self, feature_size=7, num_bboxes=2, num_classes=20, lambda_coord=5.0, lambda_noobj=0.5):
        ...
        :param feature_size: grid cell size
        :param num_bboxes: number of bboxes per each cell
        :param num_classes: number of the object classes
        :param lambda_coord: weight for bbox location/size losses
        :param lambda_noobj: weight for no-objctness loss
        '''
