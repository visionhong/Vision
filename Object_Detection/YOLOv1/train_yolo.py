...
from YOLOv1.voc import VOCDataset
from YOLOv1.darknet import DarkNet
from YOLOv1.yolo_v1 import YOLOv1
from YOLOv1.loss import Loss
...
assert use_gpu, 'Current implementation does not support GPU mode. Enable CUDA'
print('CUDA current_device:{}'.format(torch.cuda.current_device()))
print('CUDA device_count: {}'.format(torch.cuda.device_count()))

# Path to data dir.
image_dir = 'E:\\Object Detection\\data\\VOC\\VOC2007\\JPEGImages\\'

# Path to label files.
train_label = './data/voc2007.txt'
val_label = './data/voc2007test.txt'

# Path to checkpoint file containing pre-trained DarkNet weight
checkpoint_path = './data/darknet53_weights_pytorch.pth'
